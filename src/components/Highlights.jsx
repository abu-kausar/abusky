...
const Highlights = () => {
    return (
        <div className='col-span-8'>
            ...
            <div>
                <h1 className='text-white text-2xl my-6'>All day long forecast</h1>

                <div className='w-full flex justify-between flex-wrap gap-5'>
                    {
                        Array(10).fill().map(() => (
                            <div key={Math.random()} className='flex flex-col rounded-2xl text-white gap-3 px-5 py-4 bg-[#1d1c1f]'>
                                <p>2:00 PM</p>
                                <p>15.48&deg;</p>
                            </div>
                        ))
